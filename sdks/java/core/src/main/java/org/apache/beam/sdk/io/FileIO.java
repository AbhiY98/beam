...
public class FileIO {
   ...
   */
  public static ReadWithContext readWithContext() {
    return new AutoValue_ContextualTextIO_ReadWithContext.Builder()
        .setCompression(Compression.AUTO)
  ...
  /**
   * Like {@link #readWithContext}, but reads each file in a {@link PCollection} of {@link
   * FileIO.ReadableFile}, returned by {@link FileIO#readMatches}.
   */
  public static ReadFilesWithContext readFilesWithContext() {
    return new AutoValue_ContextualTextIO_ReadFilesWithContext.Builder()
  ...
  /** Implementation of {@link #readWithContext}. */
  @AutoValue
  public abstract static class ReadWithContext
      extends PTransform<PBegin, PCollection<RecordWithMetadata>> {
    ...
    abstract static class Builder {
      ...
      abstract ReadWithContext build();
    }
     ...
     */
    public ReadWithContext from(String filepattern) {
      checkArgument(filepattern != null, "filepattern can not be null");
      return from(StaticValueProvider.of(filepattern));
    }

    /** Same as {@code from(filepattern)}, but accepting a {@link ValueProvider}. */
    public ReadWithContext from(ValueProvider<String> filepattern) {
      checkArgument(filepattern != null, "filepattern can not be null");
      return toBuilder().setFilepattern(filepattern).build();
    }

    /** Sets the {@link MatchConfiguration}. */
    public ReadWithContext withMatchConfiguration(MatchConfiguration matchConfiguration) {
     ...
     * Note: this reduces the read performance.
     */
    public ReadWithContext withHasMultilineCSVRecords(Boolean hasMultilineCSVRecords) {
     ...
     */
    public ReadWithContext withCompression(Compression compression) {
     ...
     */
    public ReadWithContext withHintMatchesManyFiles() {
            ...
            input
                ...
                .apply(
                    ...
                    FileIO.readMatches()
                        ...
                        .withDirectoryTreatment(ReadMatches.DirectoryTreatment.PROHIBIT))
                .apply("Via ReadFiles", readFilesWithContext().withDelimiter(getDelimiter()));
      }
  ...
  /** Implementation of {@link #readFilesWithContext}. */
  @AutoValue
  public abstract static class ReadFilesWithContext
    ...
    abstract static class Builder {
      ...
      abstract ReadFilesWithContext build();
    }

    @VisibleForTesting
    ReadFilesWithContext withDesiredBundleSizeBytes(long desiredBundleSizeBytes) {
      return toBuilder().setDesiredBundleSizeBytes(desiredBundleSizeBytes).build();
    }

    /** Like {@link ReadFilesWithContext#withDelimiter}. */
    public ReadFilesWithContext withDelimiter(byte[] delimiter) {
      return toBuilder().setDelimiter(delimiter).build();
    }
