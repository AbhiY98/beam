 ...
 * instantiate a transform and use {@link Read#from(String)} to specify the path of the
 * file(s) to be read. Alternatively, if the filenames to be read are themselves in a {@link
 * PCollection} you can use {@link FileIO} to match them and {@link ContextualTextIO#readFiles} to read them.
 *
 ...
 * specified delimiter see {@link Read#withDelimiter}).
 *
 ...
 * {@link Write#to(String)} to specify the output prefix of the files to write.
 *
 * <p>For example:
 *
 * <pre>{@code
 ...
 * custom {@link FilenamePolicy} can also be set using {@link Write#to(FilenamePolicy)}.
 *
 * <h3>Advanced features</h3>
 *
 * <p>{@link ContextualTextIO} supports all features of {@link FileIO#write} and {@link FileIO#writeDynamic},
 ...
 * }</pre>
 *
 * <p>For backwards compatibility, {@link ContextualTextIO} also supports the legacy {@link
...
public class ContextualTextIO {
   ...
   * line.
   *
   * <p>This version allows you to apply {@link ContextualTextIO} writes to a PCollection of a custom type
  ...
  /**
   * This class is used as the default return value of {@link ContextualTextIO#write()}.
   *
   * <p>All methods in this class delegate to the appropriate method of {@link TypedWrite}.
  ...
  public static class Write extends PTransform<PCollection<String>, PDone> {
    ...
    Write() {
      this(ContextualTextIO.writeCustomType());
    }
